				...
				<Grid>
					...
					<form action={ postUrl } method="POST">
					    ...
					    <div>
					        ...
					        <input className="inline" type="text" id="url" name="url" required />
					    </div>
					    <div>
					    	<label htmlFor="review">Review:</label>
					    	<textarea rows="3" cols="60" minLength="100" id="review" name="review" required></textarea>
					    </div>

					    <p style={{ paddingTop: '20px' }}>Scores (0-100):</p>
					    <div>
					        <label htmlFor="score_transparency">Transparency:</label>
					        <input type="number" id="score_transparency" name="score_transparency" min="0" max="100" required />
					    </div>

					    <div>
					        <label htmlFor="score_governance">Governance:</label>
					        <input type="number" id="score_governance" name="score_governance" min="0" max="100" required />
					    </div>

					    <div>
					        <label htmlFor="score_legal">Legal:</label>
					        <input type="number" id="score_legal" name="score_legal" min="0" max="100" required />
					    </div>

					    <div>
					        <label htmlFor="score_functionality">Functionality:</label>
					        <input type="number" id="score_functionality" name="score_functionality" min="0" max="100" required />
					    </div>
